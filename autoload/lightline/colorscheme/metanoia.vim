...
let s:p.insert.left = [ [ '#eff0eb', '#849c84' ],[ '#b98046', '#191919' ] ]
let s:p.insert.right = [ [ '#eff0eb', '#849c84' ],[ '#b98046', '#191919' ] ]
let s:p.replace.left = [ [ '#eff0eb', '#cf7777' ],[ '#b98046', '#191919' ] ]
let s:p.replace.right = [ [ '#eff0eb', '#cf7777' ],[ '#b98046', '#191919' ] ]
let s:p.visual.left = [ [ '#eff0eb', '#d3b373' ],[ '#b98046', '#191919' ] ]
let s:p.visual.right = [ [ '#eff0eb', '#d3b373' ],[ '#b98046', '#191919' ] ]
